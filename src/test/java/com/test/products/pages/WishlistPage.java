...
public class WishlistPage extends BaseStep {
    ...
    public WebElement addToCart(int lowestPrice) {
        ...
        return waitForElementPresent(By.xpath("//*[@id=\"yith-wcwl-form\"]/table//tr/td[4]/ins/span/bdi/ancestor::tr//*[contains(text(),'"+lowestPrice+"')]/ancestor::tr//td[6] | //*[@id=\"yith-wcwl-form\"]/table//tr/td[4]/span/bdi/ancestor::tr//*[contains(text(),'"+lowestPrice+"')]/ancestor::tr//td[6]"));
    }

    public WebElement itemName(int lowestPrice) {
        return waitForElementPresent(By.xpath("//*[@id=\"yith-wcwl-form\"]/table//tr/td[4]/ins/span/bdi/ancestor::tr//*[contains(text(),'"+lowestPrice+"')]/ancestor::tr//td[3] |//*[@id=\"yith-wcwl-form\"]/table//tr/td[4]/span/bdi/ancestor::tr//*[contains(text(),'"+lowestPrice+"')]/ancestor::tr//td[3]"));
    }

    public WebElement viewCart() {
        return waitForElementPresent(By.xpath("//*[@id='blog']//i[@class='la la-shopping-bag']"));
    }
}
